...
When you're done, click on _Generate Project_ and extract the generated archive content somewhere on your disk.

[TIP]
====
Alternatively, you may do this from the command-line:
